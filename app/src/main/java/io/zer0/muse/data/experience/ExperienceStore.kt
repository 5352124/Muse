...
/**
 * File-based experience store (openhanako experience.ts port).
 *
 * Progressive disclosure pattern:
 *  - experience.md = index (category + description + path)
 *  - experience/{category}.md = category files (numbered list)
 *
 * Index is auto-generated by rebuildIndex(), not hand-written.
 * Works alongside the Room-based ExperienceRepository for dual storage.
 */
class ExperienceStore(private val context: Context) {
    ...
    /** Rebuild the index file by scanning experience directory. */
    ...
    /** Record an entry to a category file and rebuild index. */
    ...
    /** Get the index content (for recall_experience no-arg). */
